...
public class TenantProvisionAPIDTO {
  ...
  public TenantProvisionAPIDTO() {
  }

  public TenantProvisionAPIDTO tenantCode(String tenantCode) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The unique identifier of the analytic tenant.")
  ...
  public TenantProvisionAPIDTO tenantDisplayName(String tenantDisplayName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The display name that is assigned to the analytic tenant.")
  ...
  public TenantProvisionAPIDTO purchasedModules(List<String> purchasedModules) {
  ...
  public TenantProvisionAPIDTO addPurchasedModulesItem(String purchasedModulesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A comma-separated list of strings that represent the Visier modules assigned to the analytic tenant.")
  ...
  public TenantProvisionAPIDTO industryCode(Integer industryCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The 6-digit NAICS code for the industry to which the analytic tenant belongs. If the code is unknown, type 000000.   For 2-digit codes, add trailing zeros at the end to reach 6 digits, such as 620000.")
  ...
  public TenantProvisionAPIDTO embeddableDomains(List<String> embeddableDomains) {
  ...
  public TenantProvisionAPIDTO addEmbeddableDomainsItem(String embeddableDomainsItem) {
  ...
  **/
  ...
  public TenantProvisionAPIDTO customProperties(List<CustomTenantPropertyDTO> customProperties) {
  ...
  public TenantProvisionAPIDTO addCustomPropertiesItem(CustomTenantPropertyDTO customPropertiesItem) {
  ...
  **/
  ...
  public TenantProvisionAPIDTO ssoInstanceIssuers(List<String> ssoInstanceIssuers) {
  ...
  public TenantProvisionAPIDTO addSsoInstanceIssuersItem(String ssoInstanceIssuersItem) {
  ...
  **/
   ...
   * @return the TenantProvisionAPIDTO instance itself
   */
  public TenantProvisionAPIDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TenantProvisionAPIDTO tenantProvisionAPIDTO = (TenantProvisionAPIDTO) o;
    return Objects.equals(this.tenantCode, tenantProvisionAPIDTO.tenantCode) &&
        Objects.equals(this.tenantDisplayName, tenantProvisionAPIDTO.tenantDisplayName) &&
        Objects.equals(this.purchasedModules, tenantProvisionAPIDTO.purchasedModules) &&
        Objects.equals(this.industryCode, tenantProvisionAPIDTO.industryCode) &&
        Objects.equals(this.embeddableDomains, tenantProvisionAPIDTO.embeddableDomains) &&
        Objects.equals(this.customProperties, tenantProvisionAPIDTO.customProperties) &&
        Objects.equals(this.ssoInstanceIssuers, tenantProvisionAPIDTO.ssoInstanceIssuers)&&
        Objects.equals(this.additionalProperties, tenantProvisionAPIDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantCode, tenantDisplayName, purchasedModules, industryCode, embeddableDomains, customProperties, ssoInstanceIssuers, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TenantProvisionAPIDTO {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TenantProvisionAPIDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TenantProvisionAPIDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TenantProvisionAPIDTO is not found in the empty JSON string", TenantProvisionAPIDTO.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TenantProvisionAPIDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TenantProvisionAPIDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TenantProvisionAPIDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TenantProvisionAPIDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<TenantProvisionAPIDTO>() {
           @Override
           public void write(JsonWriter out, TenantProvisionAPIDTO value) throws IOException {
           ...
           @Override
           public TenantProvisionAPIDTO read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TenantProvisionAPIDTO instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TenantProvisionAPIDTO given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TenantProvisionAPIDTO
  * @throws IOException if the JSON string is invalid with respect to TenantProvisionAPIDTO
  */
  public static TenantProvisionAPIDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TenantProvisionAPIDTO.class);
  }

 /**
  * Convert an instance of TenantProvisionAPIDTO to an JSON string
  *
  * @return JSON string
  */
